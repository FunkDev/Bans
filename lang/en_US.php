...
class Lang {
    public function __construct() {
        ...
        $this->index_allsins = 'Here is where all the BeastyNetwork punishments are listed. If you have any questions, fill out a suppirt ticket on our website! Remember, this is only the history of punishments, and they may not be active.';
